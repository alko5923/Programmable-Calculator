...
// *** Represents the "greater than" conditional statement: if a > b ***

public class GreaterThan extends Conditional {
    ...
    public GreaterThan(SymbolicExpression value1, SymbolicExpression value2, SymbolicExpression isTrue, 
