...
// *** Represents the "greater than or equal to" conditional statement: if a >= b ***

public class GreaterThanOrEqualTo extends Conditional {
    ...
    public GreaterThanOrEqualTo(SymbolicExpression value1, SymbolicExpression value2, SymbolicExpression isTrue, 
